...
/**
 * Zone de livraison d'un producteur (cahier fonctionnel : rayon ou polygone dans lequel le producteur
 * accepte de livrer). $radiusKm sert au calcul simple par distance ; $zone (polygone PostGIS) permet une
 * zone dessinée à la main plus précise que le rayon -- les deux coexistent, un producteur peut n'utiliser
 * que l'un des deux. $rules (json) porte les conditions annexes (franco de port, jours de livraison...).
 */
