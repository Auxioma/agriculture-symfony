...
/**
 * Parrainage entre deux utilisateurs (cahier fonctionnel : programme de parrainage). $referrer est
 * l'utilisateur qui invite, $referred celui qui s'est inscrit via le $code de parrainage. Aucun contrôleur
 * n'existe encore pour cette entité -- la table est présente dans le schéma mais pas encore exploitée.
 */
