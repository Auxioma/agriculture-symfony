...
/**
 * Recherche sauvegardée par un utilisateur, avec alerte optionnelle ($notificationsEnabled) si de nouveaux
 * résultats correspondent à $criteria (json, les critères de filtre libres). Aucun contrôleur n'existe
 * encore pour cette entité -- la table est présente dans le schéma mais pas encore exploitée.
 */
