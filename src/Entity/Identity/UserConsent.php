...
/**
 * Trace RGPD d'un consentement donné par l'utilisateur (cahier fonctionnel : "consentement clair"),
 * versionné (ex. CGU v2, v3...) pour pouvoir redemander l'accord après une mise à jour. IP et date
 * capturées comme preuve. Aucune route actuelle n'en crée -- prévu pour le tunnel d'inscription/CGU côté
 * Angular.
 */
